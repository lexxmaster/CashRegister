...
CREATE TABLE orders (
    id INT PRIMARY KEY AUTO_INCREMENT,
    checkout_shift_id INT NOT NULL,
...
INSERT INTO roles (id, roles_name) VALUES (1, 'cashier');
INSERT INTO roles (id, roles_name) VALUES (2, 'senior_cashier');
INSERT INTO roles (id, roles_name) VALUES (3, 'commodity_expert');
INSERT INTO roles (id, roles_name) VALUES (4, 'admin');

INSERT INTO users (login, passwd, roles_id) VALUES ('cashier', '1', 1);
INSERT INTO users (login, passwd, roles_id) VALUES ('admin', 'admin', 4);

INSERT INTO warehouses (id, warehouses_name) VALUES (1, 'main');