...
<c:if test="${currentPage != 1}">
    <td><a href="controller?action=goods_list&page=${currentPage - 1}"><fmt:message key="goods.previous"/></a></td>
</c:if>
...
<c:if test="${currentPage lt noOfPages}">
    <td><a href="controller?action=goods_list&page=${currentPage + 1}"><fmt:message key="goods.next"/></a></td>
</c:if>
</body>
</html>
